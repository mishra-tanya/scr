...
<body>
    ...
    <div class="container mt-4"><br><br>
        <h2 class="text-center text-capitalize" style="text-decoration: underline"><b>{{ $user->first_name }} {{ $user->last_name }}</b>
        </h2>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-4">
                        <p class="text-capitalize"><strong>User Name: </strong> {{ $user->first_name }}
                            {{ $user->last_name }}</p>
                    </div>
                    <div class="col-4">
                        ...
                        <tbody>
                            @foreach ($results as $i => $result)
                                <tr>
                                    ...
                                    <td>{{ $result->created_at->format('Y-m-d') }}</td>
                                    {{-- <td><a href="{{ route('admin.scr.test.details', ['chapter_id' => $result->chapter_id,'email'=>$user->email]) }}">View </a> --}}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
