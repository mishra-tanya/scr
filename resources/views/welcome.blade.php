    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
         @auth
         <h2 class=" text-capitalize">Testing Welcome {{Auth::user()->first_name}}, to</h2>
         @endauth
        ...
        <div class="row">
            ...
            <div class="icon-box iconbox-blue">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <circle class="circle" cx="50" cy="50" r="50" fill="#f5f5f5" />
                </svg>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="">Test series & Mock tests</a></h4>
              <p>Tests series according to chapters with long-term access.</p>
            </div>
          </div>
          ...
          {{-- <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <h4><a href="">Accessable Video Solutions</a></h4>
              <p>Easy access video solutions for better understanding of the user.</p>
            </div>
          </div> --}}
    ...
    {{-- <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row ">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="zoom-im" data-aos-delay="100">
            <div class="box">
              <h3>Free</h3>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h3>Premium</h3>
              <h4><sup>&#8377;</sup>1833<span> / month</span></h4>
              <ul>
