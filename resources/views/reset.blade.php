...
<style>
    /* Custom CSS for smaller card width */
    .custom-card {
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-lg" style="border-radius:15px;">
                <div class="card-header text-light" style="background-color: rgba(1, 52, 88, 0.811); 
                font-size:21px;
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary"style="background-color: rgba(55, 142, 181, 0.9);
                                padding:12px;
                                border-radius:10px;
                                border:none;
                                border:4px double rgb(219, 219, 219)
                                ">
                                    {{ __('Reset Password') }}
                                </button>
                            </div>
