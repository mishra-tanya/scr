        ...
        <div class="row" style="display:flex;justify-content:center; align-items:center; ">
            ...
            <div class="col-md-3 text-center" >
                <form action="{{ route('store.notes') }}" method="POST">
                    @csrf
                    <input type="hidden" name="chapter" value="{{ $note->page_url }}">
                    <button type="submit" class="card mb-4 p-1" style="font-size:3000px;background-color: {{ in_array($note->page_url, $chapterNotes) ? '#9dcee0' : '#f5f5f5' }}">
