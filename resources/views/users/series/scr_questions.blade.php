            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card" style="max-width:1200px;background-color:#E6F7FF">
                    <div class="card-content">
                        ...
                        <form method="POST" action="{{ route('update-test-status') }}">
                            @csrf
                            <input type="hidden" name="chapter_id" value="{{ $mockTest['chapter_id'] }}">
                            <input type="hidden" name="link" value="{{ $mockTest['link'] }}">
                            <input type="hidden" name="status" value="{{ $mockTest['status'] }}">
                            <input type="hidden" name="testLabel" value="{{ $mockTest['label'] }}">
                            <input type="hidden" name="userId" value="{{ auth()->user()->id }}">
                    
                            <div class="card-item row">
                                <div class="col-5">
                                    <div class="card-label">{{ $mockTest['label'] }}</div>
                                </div>
