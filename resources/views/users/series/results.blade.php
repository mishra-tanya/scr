...
<body>
    ...
    <div class="text-center">
        <h2><b>Chapter: {{ substr($chapter_id, 1,1) }}</b><span class="d-none d-md-inline">&nbsp;&nbsp;&nbsp;</span>
            <b class="d-block d-md-inline">Test Series: {{ substr($chapter_id, 3,1) }}</b></h2>
    </div> <br>
                        ...
                        <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                            <svg viewBox="0 0 36 36" class="circular-chart">
                                <path class="circle-bg" d="M18 2.0845
                                    ...
                                    a 15.9155 15.9155 0 0 1 0 -31.831"/>
                                <path id="circle" class="circle" stroke-dasharray="{{ $correctAnswers / $totalQuestions * 100 }}, 100" d="M18 2.0845
                                    a 15.9155 15.9155 0 0 1 0 31.831
                                    a 15.9155 15.9155 0 0 1 0 -31.831"/>
                                <text x="18" y="20.35" class="percentage">{{$correctAnswers}} /{{ $totalQuestions }}</text>
                            </svg>
                        </div>
                    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="question shadow-lg">
            ...
            <div class="options">
                <div class="option @if($question['user_answer'] == 'A') @if($question['user_answer'] == $question['correct_answer']) correct @else incorrect @endif @endif">
                    <b>A:</b> {{ $question['option_a'] }}
                </div>
                <div class="option @if($question['user_answer'] == 'B') @if($question['user_answer'] == $question['correct_answer']) correct @else incorrect @endif @endif">
                    <b>B:</b> {{ $question['option_b'] }}
                </div>
                <div class="option @if($question['user_answer'] == 'C') @if($question['user_answer'] == $question['correct_answer']) correct @else incorrect @endif @endif">
                    <b>C:</b> {{ $question['option_c'] }}
                </div>
                <div class="option @if($question['user_answer'] == 'D') @if($question['user_answer'] == $question['correct_answer']) correct @else incorrect @endif @endif">
